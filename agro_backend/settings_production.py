"""
Django settings for agro_backend project - Production configuration.
"""
...
ALLOWED_HOSTS = ['34.136.15.241', 'localhost', '127.0.0.1', '*'] #os.getenv('ALLOWED_HOSTS', 'localhost,127.0.0.1,34.136.15.241,0.0.0.0').split(',')
