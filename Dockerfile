...
CMD ["gunicorn", "--bind", "0.0.0.0:8000", "--workers", "10", "--worker-class", "gevent", "--worker-connections", "1000", "--timeout", "120", "--keep-alive", "2", "--max-requests", "1000", "--max-requests-jitter", "100", "--preload", "gunicorn_async:application"]
